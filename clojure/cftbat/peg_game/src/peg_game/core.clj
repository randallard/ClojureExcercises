...
;; test: use this to create a map of :position :valid-moves
;; (map first (filter #(get (second %) :pegged) (remove-peg test-board 1)))
...
(defn letter->pos
  "Converts a letter strign to the corresponding position number"
  [letter]
