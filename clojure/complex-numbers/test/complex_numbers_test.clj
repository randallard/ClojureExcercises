...
(deftest addition-of-real-numbers
  (is (= [2 0] (c/add [1 0] [1 0]))))

(deftest addition-of-imaginary-numbers
  (is (= [0 2] (c/add [0 1] [0 1]))))

(deftest addition-of-complex-numbers
  (is (= [2 3] (c/add [0 2] [2 1]))))

(deftest subtraction-of-real-numbers
  (is (= [1 0] (c/sub [3 0] [2 0]))))

(deftest subtraction-of-imaginary-numbers
  (is (= [0 1] (c/sub [0 3] [0 2]))))

(deftest multiplication-of-complex-numbers
  (is (= [-5 10] (c/mul [1 2] [3 4]))))

(deftest returns-real-part
  (is (= 1 (c/real [1 2]))))

(deftest returns-imaginary-part
  (is (= 2 (c/imaginary [1 2]))))

(deftest returns-absolute-value
  (is (= (Math/sqrt 2) (c/abs [1 1]))))

(deftest returns-complex-conjugate
  (is (= [1 -2] (c/conjugate [1 2]))))

(deftest division-of-complex-numbers
  (is (= [11/25 2/25] (c/div [1 2] [3 4]))))
